...
function Revolution({ setTabValue }) {
  ...
  const revolutionSections = [
    ...
    },
    {
      ...
      iconAlt: "Build Icon",
      iconMaxWidth: matchesMD ? 700 : 1000,
  ...
  return (
    <Grid container direction="column">
      <Head>
        <title key="title">
          West Coast Technology in the Midwest | Arc Development
        </title>
        <meta
          name="description"
          key="description"
          content="Visionary insights coupled with cutting-edge 
          technology is a recipe for revolution. Get a free 
          online estimate instantly for your online project now!"
        />
        <meta
          property="og:title"
          key="og:title"
          content="Arc Development | The Revolution"
        />
        <meta
          property="og:url"
          key="og:url"
      ...
      >
        ...
        >
          <Lottie
            ...
            style={{
              maxWidth: matchesSM ? "300px" : "40em",
              marginTop: matchesMD && "5em",
              marginLeft: matchesMD || "5em",
              marginBottom: 0,
              marginRight: 0,
            }}
          />
      ...
      {revolutionSections.map((section) => (
        <Grid
          key={Math.random()}
          item
          container
